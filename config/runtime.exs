...
secret_files =
  System.get_env("SECRET_FILES", "/run/secrets/bsky_labeler_secret,secret")
  |> String.split(~r/(?<!\\),/)
...
config :bsky_labeler, BskyLabeler.Repo,
  log: false,
  database: "bsky_labeler_repo",
  username: "postgres",
  password: get.("POSTGRES_PASSWORD") || "dev_postgres_pw",
  hostname: get.("POSTGRES_HOST") || "localhost",
  port: get.("POSTGRES_PORT") || "5432"

config :bsky_labeler, BskyLabeler.WebEndpoint, secret_key_base: get.("PHOENIX_SECRET_KEY_BASE")
